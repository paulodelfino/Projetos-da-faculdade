...
public class ArduinoIHM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton11.setText("Sequencial 01 - Ativar");
        ...
        jButton12.setText("Sequencial 02 - Ativar");
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if (jButton11.getText().equals("Sequencial 01 - Ativar")) {
            arduino.send("q");
            jButton11.setText("Sequencial 01 - Desativar");
            ArduinoBLL.setFlag(true);
            sequenciaUm = new Sequencial1(jTextField1);
            sequenciaUm.start();
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        if (jButton12.getText().equals("Sequencial 02 - Ativar")) {
            jButton12.setText("Sequencial 02 - Desativar");
            ArduinoBLL.setFlag(true);
            sequenciaDois = new Sequencial2(jTextField1);
            sequenciaDois.start();
            arduino.send("w");
        } else {
            jButton12.setText("Sequencial 02 - Ativar");
    ...
    private Sequencial1 sequenciaUm;
    private Sequencial2 sequenciaDois;
